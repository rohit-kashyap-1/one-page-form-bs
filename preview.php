...
<head>
    ...
    <title>Homepage for data collection</title>
...
<body>
    ...
    <section id="hero" class="d-flex align-items-center text-start" style="height: auto;">
        ...
        <div class="container d-flex flex-column align-items-center  justify-content-center" data-aos="" style="padding-top: 30px;">
            <div class="preview">
                <div class="inner">
                    <div class="img">
                        <img src="assets/img/m111.png" class="img-fluid">
                    </div>
                    <div class="text">
                        <div>
                            <h2>Relief Clinic</h2>
                            <h1>DR. <?php echo $data->name; ?></h1>
                            <h3><?php echo $data->designation; ?></h3>
                            <p><i class="fa fa-phone"></i> Call <?php echo $data->phone; ?></p>
                        </div>
                        <div>
                            <p>Reg. <?php echo $data->reg_no ?></p>
                        </div>
                    </div>
                </div>
                <hr>
